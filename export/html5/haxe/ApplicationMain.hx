...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("apollo", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("apollo", null, 960, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "apollo";
		app.meta["name"] = "Apollon Sunrise";
